...
class PrivateRecipeAPITestCase(TestCase):
  ...
  def test_get_recipe_detail(self):
    ...
    self.assertDictEqual(res.data, serializer.data)
  ...
  def test_create_recipe_with_new_ingredients(self):
    '''Test cresting a recipe with new ingredient.'''
    
    payload= {
      'title': 'Coliflower tacos',
      'time_minutes': 40,
      'price': Decimal('4.50'),
  ...
  def test_creating_a_new_recipe_with_existing_ingredients(self):
  ...
  def test_create_ngredient_on_update(self):
  ...
  def test_filter_by_tags(self):
    ...
    recipe1= create_recipe(user= self.user, title= 'Thai Vegatable Curry')
